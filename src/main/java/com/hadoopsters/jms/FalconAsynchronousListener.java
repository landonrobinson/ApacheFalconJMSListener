        ...
        consumer.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message messageRaw) {
                try {
                    ...
                    Date startTime = OozieFetcher.getStartTime(parentWorkflow, oozieClient);
                    Date endTime = OozieFetcher.getEndTime(parentWorkflow, oozieClient);
                    SimpleDateFormat date_format = new SimpleDateFormat("HH:mm");
                    String startTime_actual = date_format.format(startTime);
                    String endTime_actual = date_format.format(endTime);
                    ...
                    try{
                        out.println("Time: " + currTimeStamp
                                ...
                                + ", Topic: " + topicName
                                + ", Broker: " + brokerTTL
                                + ", Start Time: " + startTime_actual
                                + ", End Time: " + endTime_actual
                        );
                        out.close();
